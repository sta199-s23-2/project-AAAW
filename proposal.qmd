...
-   Question: What 3 comorbidities were most associated with mortality due to COVID-19.

-   Importance: Identification of diseases and conditions that are most directly related to mortality from COVID-19 provides valuable information regarding how patients should be treated and which individuals should take extra precautions to avoid infection. Treatment plans can be catered to these conditions: for example, an individual that is suffering from a "dangerous" co-morbidity in the context of COVID-19 can be immediately prescribed an antiviral like Nirmatrelvir/ritonavir to avoid complications and mortality.

-   Our research topic will focus on determining the 3 co-morbid conditions that are most related to COVID-19 mortality. We will analyze how condition groups and/or conditions impact the incidence of COVID-19 mortality.

...
1.  Points Per 36 minutes: (points per game / minutes per game) \*36 \> 16
    ...
    1.  16 pp36 is approximately the 60th percentile of pp36, per basketball reference[^6], so we decided to use it as our threshold. 
...
[^6]: [https://www.basketballreference.com/leagues/NBA_2021_per_minute.html](https://www.basketball-reference.com/leagues/NBA_2021_per_minute.html)
...
1.  Player Efficiency Rating \>=15 
    ...
    1.  15 is approximately the 60th percentile of PER, from basketball reference[^7], so we used it as our threshold value 
...
2.  Win Shares per 48 min \>= 0.1
    ...
    1.  0.1 is approximately 50th percentile[^8] (Win shares are distributed across a team so to get an accurate assessment of how many people contributed we need a bit more lenient threshold otherwise it would be egregiously small)  
...
[^7]: <https://www.basketball-reference.com/playoffs/NBA_2022_advanced.html>
